...
export class ProductosService {
  ...
  saveMedidasEscritorio(object, callback: any) {
    return this.http.post(0, this.servers.serverName + '/producto/image/medida/escritorio', object, callback);
  }

  saveMedidasMovil(object, callback: any) {
    return this.http.post(0, this.servers.serverName + '/producto/image/medida/movil', object, callback);
  }
