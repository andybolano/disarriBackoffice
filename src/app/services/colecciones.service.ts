...
export class ColeccionService {
   ...
   saveItem(object: any, callback: any) {
    return this.http.post(0, this.servers.serverName + '/coleccion/item', object, callback);
    }

    getAllItems(id: any, callback: any) {
        return this.http.get(0, this.servers.serverName + '/coleccion/'+id+'/item', callback);
    }

    updateStateItem(object:any,callback:any){
        return this.http.post(0, this.servers.serverName + '/coleccion/update/state/item',object,callback);
      }

      updateOrdenItem(object,callback:any){
        return this.http.post(0, this.servers.serverName + '/coleccion/update/orden/item',object,callback);
      }
      eliminarItem(id:Number,callback: any){
        return this.http.get(0, this.servers.serverName + '/coleccion/delete/item/'+id, callback);
    }

    updateItem(object:any,callback: any) {
        return this.http.post(0, this.servers.serverName + '/coleccion/update/item', object, callback);
    }
