...
export class BannerService {
   ...
   updateMenu(object:any,callback:any){
    return this.http.post(0, this.servers.serverName + '/banner/update/menu',object,callback);
  }

   updateOrden(object,callback:any){
    return this.http.post(0, this.servers.serverName + '/banner/update/orden',object,callback);
  }
}